...
== This branch ==
This is NOT an official repository for unoconv.
This is a fork of vaurum repository on https://github.com/vaurum/unoconv
...which is, in turn, a fork of zopa repostiory on https://github.com/zopa/unoconv

Varum opened the sheet branch which let to specify a sheet on exporting.

I added a few improvements:
  - The ability to use it's numerical position.
  - Better error reporting.
  - And updted help message.
